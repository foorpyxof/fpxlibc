#ifndef FPX_LINKEDLIST_HPP
#define FPX_LINKEDLIST_HPP
...
public:
  ...
  LinkedList(const char *name = "unnamed list")
      : m_Name(name), m_Length(0), m_FirstNode(nullptr) {}
  ~LinkedList();
  ...
  /**
   * Insert a node at the specified index, pushing any other nodes ahead if
   * necessary.
   */
  ...
  /**
   * Prints all linked list data, such as the name and the nodes and their
   * values.
   */
  void Print() const;
