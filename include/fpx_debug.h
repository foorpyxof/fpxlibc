...
#undef FPX_DEBUG
#define FPX_DEBUG(fmt, ...) \
  fprintf(stderr, "\033[0;32mFPXLIBC DEBUG:\033[0m " fmt "\033[0m" __VA_OPT__(, ) __VA_ARGS__)

#undef FPX_WARN
#define FPX_WARN(fmt, ...) \
  fprintf(stderr, "\033[0;93mFPXLIBC WARN: \033[0m " fmt "\033[0m" __VA_OPT__(, ) __VA_ARGS__)
...
#define FPX_ERROR(fmt, ...)                                                                  \
  {                                                                                          \
    ...
    fprintf(stderr,                                                                          \
      "\033[0;91mFPXLIBC ERROR:\033[0m " fmt "\033[0m (at %s)\n" __VA_OPT__(, ) __VA_ARGS__, \
