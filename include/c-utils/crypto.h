 ...
 * Last argument decides on whether or not it's printable (hex string
 * representation) or not (pure bytes).
 */
...
void fpx_hmac(const uint8_t *key, size_t keyLength, const uint8_t *data,
